...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/signup.css?version=3">
  ...
  <body>
    <div class="inner-container">
      ...
      <div class="content-wrapper">
        <div class="form-area">
          <div class="header-sitter">
            <h2>Sign up form (Pet Sitter)</h2>
          </div>
          <form name="signup_form" class="suForm form-horizontal form_font" method="POST" action="signup_post_ps.php" onsubmit="return Validate()">
            ...
            <div class="sign_up_submit">
              <center>
                <input type="submit" name="submit" value="Sign up!" class="btn sitter"/>
              </center>
            </div>
          </form>
        </div>
